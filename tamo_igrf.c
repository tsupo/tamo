 ...
 * History :
 * $Log: tamo_igrf.c $
 * Revision 1.15  2012/07/26  06:34:32  tsujimura543
 * IGRF2010のデータを修正
 *
 * Revision 1.14  2012/07/26  06:11:35  tsujimura543
 * IGRF2010モデルに対応
 *
 * Revision 1.13  2012/07/26  04:56:02  tsujimura543
 * IGRF2005のデータを修正
 *
...
static struct igrf1990table     {   /* IGRF1990 model パラメータテーブル */
    ...
    /* 理科年表 1993年版より */
    /* see also http://www.ipgp.fr/~cogne/pub/paleomac/PMhelp/starting/PMdata_files/IGRF1990 */
...
struct igrf1990table    igrf2005[] = {
    ...
    {  2,  0,  -2341,     0, -15.0,   0.0 },
    {  2,  1,   3047, -2595,  -6.9, -23.3 },
    {  2,  2,   1657,  -517,  -1.0, -14.0 },
    {  3,  0,   1336,     0,  -0.3,   0.0 },
    {  3,  1,  -2305,  -200,  -3.1,   5.4 },
    {  3,  2,   1247,   269,  -0.9,  -6.5 },
    {  3,  3,    674,  -525,  -6.8,  -2.0 },
    {  4,  0,    920,     0,  -2.5,   0.0 },
    {  4,  1,    798,   281,   2.8,   2.0 },
    {  4,  2,    212,  -226,  -7.1,   1.8 },
...
struct igrf1990table    igrf2010[] = {
    {  1,  0, -29497,     0,  11.40,   0.00 },
    {  1,  1,  -1586,  4945,  16.70, -28.80 },
    {  2,  0,  -2397,     0, -11.30,   0.00 },
    {  2,  1,   3026, -2708,  -3.90, -23.00 },
    {  2,  2,   1669,  -575,   2.70, -12.90 },
    {  3,  0,   1340,     0,   1.30,   0.00 },
    {  3,  1,  -2326,  -160,  -3.90,   8.60 },
    {  3,  2,   1232,   252,  -2.90,  -2.90 },
    {  3,  3,    634,  -537,  -8.10,  -2.10 },
    {  4,  0,    913,     0,  -1.40,   0.00 },
    {  4,  1,    809,   286,   2.00,   0.40 },
    {  4,  2,    167,  -211,  -8.90,   3.20 },
    {  4,  3,   -357,   164,   4.40,   3.60 },
    {  4,  4,     90,  -309,  -2.30,  -0.80 },
    {  5,  0,   -231,     0,  -0.50,   0.00 },
    {  5,  1,    357,    45,   0.50,   0.50 },
    {  5,  2,    200,   189,  -1.50,   1.50 },
    {  5,  3,   -141,  -118,  -0.70,   0.90 },
    {  5,  4,   -163,     0,   1.30,   3.70 },
    {  5,  5,     -8,   101,   1.40,  -0.60 },
    {  6,  0,     73,     0,  -0.30,   0.00 },
    {  6,  1,     69,   -21,  -0.30,  -0.10 },
    {  6,  2,     76,    44,  -0.30,  -2.10 },
    {  6,  3,   -141,    62,   1.90,  -0.40 },
    {  6,  4,    -23,   -66,  -1.60,  -0.50 },
    {  6,  5,     13,     3,  -0.20,   0.80 },
    {  6,  6,    -78,    55,   1.80,   0.50 },
    {  7,  0,     80,     0,   0.20,   0.00 },
...
igrfsub( double latitude, double longitude, double t0, double t6 )
{
    ...
    case 105:   /* IGRF2005 */
        ...
        break;
    case 110:   /* IGRF2010 */
        size = sizeof ( igrf2010 ) / sizeof ( struct igrf1990table );
        ip   = &igrf2010[0];
        break;
    }
